...
.. code-block:: bash
    ...
    fastapi-mvc available under: http://iam.192.168.49.2.nip.io/
...
.. code-block:: bash
    ...
    ...
    Kubernetes cluster ready
    FastAPI available under: http://iam.192.168.49.2.nip.io/
    You can delete dev-env by issuing: make clean
    vagrant@ubuntu-focal:/syncd$ kubectl get all -n iam
    NAME                        READY   STATUS    RESTARTS   AGE
    pod/iam-649966bb7f-r694l   1/1     Running   0          114s

    NAME           TYPE        CLUSTER-IP    EXTERNAL-IP   PORT(S)    AGE
    service/iam   ClusterIP   10.97.16.46   <none>        8000/TCP   114s

    NAME                   READY   UP-TO-DATE   AVAILABLE   AGE
    deployment.apps/iam   1/1     1            1           114s

    NAME                              DESIRED   CURRENT   READY   AGE
    replicaset.apps/iam-649966bb7f   1         1         1       114s
    vagrant@ubuntu-focal:/syncd$ curl http://iam.192.168.49.2.nip.io/api/ready
    {"status":"ok"}
Documentation
-------------
